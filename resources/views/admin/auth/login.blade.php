...
<div class="main-wrapper">
    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20" style="font-size:18px;color:White">
                <b class="logo-icon p-l-10">
                    <img src="http://127.0.0.1:8000/admin-panel/assets/images/logo-icon.png" alt="homepage" class="light-logo">
                </b>
                <span class="logo-text">
                             <!-- dark Logo text -->
                             
                             Employee Managemet Portal 

                        </span>

                    <span class="db">
                    {{--<img src="{{asset('admin-panel/assets/images/logo.png')}}" alt="logo" /></span>--}}
                </div>
                <!-- Form -->
